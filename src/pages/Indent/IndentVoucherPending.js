        ...
        <>
            <div className="settings-content">
                <div className=' d-flex justify-content-between pb-3' style={{ borderBottom: '1px solid #e6e6e6ff' }}>
                    <div className="heading mb-0 pb-0" style={{ borderBottom: 'none' }}>Indent Voucher Pending</div>
                ...
                <div className="table-responsive" style={{ overflowX: 'auto' }}>
                    <table className="table table-bordered mt-3" style={{ minWidth: '1300px', tableLayout: 'fixed' }}>
                        <thead>
                            <tr>
                                ...
                                <th style={{border: '1px solid #dee2e6', padding: '8px 12px', fontWeight: '600', textAlign: 'center', width: '110px',background:'#f8f9fa',color:'#495057'}}>Indent Qty</th>
                                <th style={{border: '1px solid #dee2e6', padding: '8px 12px', fontWeight: '600', textAlign: 'center', width: '110px',background:'#f8f9fa',color:'#495057'}}>Pre-Closed Qty</th>
                                <th style={{border: '1px solid #dee2e6', padding: '8px 12px', fontWeight: '600', textAlign: 'center', width: '110px',background:'#f8f9fa',color:'#495057'}}>Order Qty</th>
                                <th style={{border: '1px solid #dee2e6', padding: '8px 12px', fontWeight: '600', textAlign: 'center', width: '110px',background:'#f8f9fa',color:'#495057'}}>Balance Qty</th>
