  ...
  return (
        ...
        <div className="row">
          <div className="col-12">
            <div className="mt-3 row">
              ...
              <div className="col-4 my-auto">
                <label htmlFor="under" className="form-label">Group Name</label>
              </div>
              <div className="col-8">
              ...
              <div className="col-4 my-auto">
                <label htmlFor="under" className="form-label">Units</label>
              </div>
              <div className="col-8">
                <select id="under" className="form-select w-100">
                  <option>Primary</option>
              ...
              <div className="col-4 my-auto">
                <label htmlFor="under" className="form-label">Alternate Units</label>
              </div>
              <div className="col-8">
                <select id="under" className="form-select w-100">
                  <option>Primary</option>
    ...
    <div className="companies-page">
      <div className="companies-header">
        <h2>Stock Item</h2>
        <button onClick={openModal} className="btn btn-primary new-btn">Add Stock Item</button>
      </div>
