  ...
  return (
    ...
    >
      <div className="d-flex justify-content-between  pb-2" style={{borderBottom: '1px solid #eee'}}>
        <div style={{fontSize:20}}>Add Unit</div>
        ...
        <div className="row">
          <div className="col-12">
            <div className="mt-3 row">
              ...
              <div className="col-4 my-auto">
                    <label htmlFor="CompanyCode" className="form-label">Symbol</label>
                </div>
                <div className="col-8">
              ...
              <div className="col-4 my-auto">
                <label htmlFor="Company" className="form-label">Decimal</label>
              </div>
              <div className="col-8">
    ...
    <div className="companies-page">
      <div className="companies-header">
        <h2>Unit</h2>
        <button onClick={openModal} className="btn btn-primary new-btn">Add Unit</button>
      </div>
