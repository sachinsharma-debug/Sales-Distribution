...
//         <div className="heading">Stock Group Creation</div>
//         <div className="row">
//             <div className="col-8">
...
//             <div className="row mt-2">
//                 <div className="col-2 my-auto">
//                     <label htmlFor="AlterID" className="form-label">Name</label>
//                 </div>
//                 <div className="col-4">
...
//             <div className="row mt-2">
//                 <div className="col-2 my-auto">
//                 <label htmlFor="tdsSelect" className="form-label">Under</label>
//                 </div>
//                 <div className="col-4">
//                 <select id="tdsSelect" className="form-select w-100">
//                     <option value="No">Primary</option>
//                     <option value="Yes">Secondary</option>
//                 </select>
//                 </div>
//             </div>
//             </div>
  ...
  return (
    ...
    >
      <div className="d-flex justify-content-between  pb-2" style={{borderBottom: '1px solid #eee'}}>
        <div style={{fontSize:20}}>Add Brand</div>
    ...
    <div className="companies-page">
      <div className="companies-header">
        <h2>Brand</h2>
        <button onClick={openModal} className="btn btn-primary new-btn">Add Brand</button>
      </div>
